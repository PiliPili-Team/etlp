...
export const en: typeof zhCN = {
    ...
    sys_log_max_size_desc: "Rotate to a new file once the current one exceeds this size",
    sys_log_max_files: "Max Log Files",
    sys_log_max_files_desc: "Number of rotated log files to keep; the oldest is removed",
