...
export const en: typeof zhCN = {
    ...
    sys_trakt_sync_note:
        "Synced automatically when playback ends: an episode is marked watched and written to history only once finished (about 90% or more), and Trakt's Up Next then shows the next one; an unfinished view is not reported; episodes of the season already finished in your media server are backfilled, and entries already in history are de-duplicated",
