...
export const en: typeof zhCN = {
    ...
    sys_log_max_size_desc: "Rotate to a new file once the current one exceeds this size (20–200 MB)",
    ...
    sys_log_max_files_desc: "Number of rotated log files to keep (1–14); the oldest is removed",
