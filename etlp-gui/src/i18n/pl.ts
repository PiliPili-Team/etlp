...
export const pl: typeof zhCN = {
    ...
    net_proxy_desc: "Format: host:port (zostaw puste, aby wyłączyć)",
    ...
    cfg_update_available: "Znaleziono nową wersję v{version} — otwieranie strony wydania",
    cfg_update_latest: "Masz najnowszą wersję v{version}",

    // Update banner
    ov_update_available: "Dostępna nowa wersja v{version}",
    ov_update_action: "Aktualizuj",
