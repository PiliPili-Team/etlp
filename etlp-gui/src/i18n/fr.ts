...
export const fr: typeof zhCN = {
    ...
    net_proxy_desc: "Format : host:port (laissez vide pour désactiver)",
    ...
    cfg_update_available:
        "Nouvelle version v{version} trouvée — ouverture de la page de publication",
    ...
    ov_update_action: "Mettre à jour",
